...
is then that in $\mathsf{sOp}^{G}_{\**}$
...
(a similar discussion concerning the 
...
$\mathsf{sOp}_{\bullet}$
of simplicial operads studied in 
...
which builds the model structures in 
fixed color operads
$\Op^G_{\mathfrak{C}}(\V)$, 
