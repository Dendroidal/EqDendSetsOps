...
$(g,\sigma)\vect C = \vect C$ for all $(g,\sigma) \in \Lambda$.
...
The constructions of these were the main results, Theorems \ref{OC-THMI}, \ref{OC-THMII}, of the prequel \cite{BP_FCOP}.
While these do not appear directly in the statement of Theorem \ref{THMA},
