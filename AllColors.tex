...
\begin{itemize}
\item the maps
\begin{equation}\label{THMA1ST EQ}
...
\begin{equation}\label{THMA2ND EQ}
\pi_0 j^{\**} \O^H 
\to 
\pi_0 j^{\**} \mathcal{P}^H 
\end{equation}
...
\eqref{THMA1ST EQ},\eqref{THMA2ND EQ}
...
\begin{remark}
	...
	while maps satisfying only \eqref{THMA1ST EQ}
...
in \eqref{THMA1ST EQ}
with the essential surjectivity in	\eqref{THMA2ND EQ}.
%
...
\eqref{THMA2ND EQ}
are fully faithful.
Therefore, the condition following \eqref{THMA2ND EQ}
...
that the maps in \eqref{THMA2ND EQ}
...
%\begin{example}
%      The categories $(\Top, \times)$ and $(\Top_{\**}, \wedge)$ of (pointed) compactly-generated weak-Hausdorff spaces and the cartesian product (resp. smash product) satisfy all the hypotheses of Theorems \ref{THMI} and \ref{THMA}: they
...
%      The fact that $\Cat$ satisfies the hypotheses of Theorems \ref{THMI} and \ref{THMA} follow analogously to the case of $\sSet$.      
...
%      All hypotheses from Theorems \ref{THMI} and \ref{THMA} are immediate,
...
\begin{proof}
	...
	(cf. \eqref{FAMTOGEN EQ} and the proof of Theorem \ref{THMI}).
...
which was used 
during the proof of Proposition \ref{J_CELL_PROP}
