...
which are given by \cite[Thm. \ref{OC-THMI}]{BP_FCOP}.
...
all follow from 
\cite[Prop. \ref{OC-WEAKCELL PROP}]{BP_FCOP}
since these $(\V,\otimes)$ satisfy the usual monoid axiom and
are readily seen to satisfy the conditions in 
\cite[Def. \ref{OC-WEAKCELL DEF}]{BP_FCOP}.
...
\begin{remark}\label{SPNONEX REM}
	...
	likely satisfy a close analogue of  
	\cite[Thms. \ref{OC-THMI} and \ref{OC-THMII}]{BP_FCOP} and Theorem \ref{THMA}.
