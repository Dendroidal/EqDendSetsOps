...
(see \eqref{FREEOP_EQ}, which is elaborated in 
...
can be found in \cite[App. \ref{OC-MONAD_APDX}]{BP_FCOP},
...
whose proof is postponed to \cite[\S \ref{OC-PUSHOUT_SEC}]{BP_FCOP}.
