...
\begin{equation}\label{PUSHOUTPROPVAR EQ}
	\begin{tikzcd}
	\coprod_r \partial \Omega(C) \ar{r} \ar{d} & \mathcal{O} \ar{d}
	\\
	\coprod_r \Omega(C) \ar{r} & \mathcal{P}.
	\end{tikzcd}
\end{equation}
	Then the induced map
\begin{equation}\label{ANODYNEVAR EQ}
	\coprod_r \Omega[C] \amalg_{\coprod_r \partial \Omega[C]} N\mathcal{O} \to N\mathcal{P}
\end{equation}
	is $G$-inner anodyne.
\end{proposition}
...
\begin{equation}
\begin{tikzcd}
	\coprod_r \Omega[C] \amalg_{\coprod_r \partial \Omega[C]} N\mathcal{O} \ar{r} \ar{d}
&
	N \mathcal{O}_r \ar{d}
\\
	\coprod_{r+1} \Omega[C] \amalg_{\coprod_{r+1} \partial \Omega[C]} N \mathcal{O} \ar{r}
&
...
\end{equation}
	...
	are $G$-inner anodyne.
	We defer the proof of the interesting $r=1$ case to \S \ref{KEYRES SEC}.
\end{remark}
...
\begin{remark}
	...
	sends the collection of arrows in (TC1) and (TC2) onto the collection of generating cofibrations \eqref{SSETGENCOF_EQ}:
	\begin{gather*}
...
\begin{proof}
	...
	Corollary \ref{SIGMAG_COF_COR} and Remark \ref{TAUCOFIB_REM}
