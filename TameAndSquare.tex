...
\todo[inline]{add minimal about (generating) broad relations - see EDSS}
...
which preserves  
\todo[inline]{add quick intro to actual broad poset structure earlier in section}
the broad poset relations on edges %  {\color{blue} the broad poset/operadic structure}
