...
\begin{definition}
      ...
      Moreover, a call a map $\phi \colon F \to F'$ an (inner,outer) face map or a degeneracy iff
...
the \textit{orbital representation} given by the sigle tree on the right.
\begin{equation}
      \begin{tikzpicture}[auto,grow=up, level distance = 2.2em,
            every node/.style={font=\scriptsize,inner sep = 2pt}]%
