...
$\mathsf{dSet}_G$
of those objects satisfying the strict Segal condition in Definition \ref{OPG_DEF} below,
...
\begin{definition}
        \label{OPG_DEF}
        A genuine equivariant dendroidal set $Z \in \dSet_G$ is a \textit{genuine equivariant operad} if
