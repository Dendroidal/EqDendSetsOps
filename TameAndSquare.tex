...
Much as was the case in \cite{CM13b},
our proof of Theorem \ref{QE THM}
makes use of two additional categories,
the category 
$\mathsf{sdSet}^G
...
then give previous Quillen equivalences

then explain what remains to be done
...
\todo[inline]{explicitly, these are fixed-point systems}
...
$\mathsf{dSet}_G$
of those objects satisfying a Segal condition ({\color{red} internal reference?}),
