...
\begin{theorem}[{\cite[Thm 2.1, Thm 8.22]{Per18}}]
      ...
      \item the fibrations between fibrant objects are precisely the maps $X \to Y$ such that the functors associated to each of the fixed-point homotopy categories $\tau j^{\**}(X^H \to Y^H)$ are isofibrations of categories for all $H \leq G$.
...
Second, $\Omega^{op} \times G$ is generalized Reedy \cite[Ex. A.7]{BP_edss},
