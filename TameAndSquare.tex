...
an explicit description, due to Dwyer and Spalinski \cite{DS11},
...
\begin{proof}
	...
	By adjunction,
	the latter claim implies follows that $hcN$ sends fibrations between fibrant objects
	to inner fibrations between $G$-$\infty$-operads.
	Hence, by Corollary \ref{SIMPLQUILL COR}
	together with Theorem \ref{DSETGMOD THM},
