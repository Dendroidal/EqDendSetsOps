...
\begin{proof}
	...
	Lastlt, for the Quillen equivalence claim, 
...
which is the key definition in {\color{red} sequel},
...
{\color{red}Reference result (Remark \ref{GTAUFUNEX REM})}
...
Let $Z \in \mathsf{dSet}_G$ be a genuine $G$-$\infty$-operad. Then:
	\begin{itemize}
	\item[(a)] $\mathop{\mathrm{ho}}(Z) \in \mathsf{dSet}_G$ is a genuine equivariant operad, i.e. it satisfies the strict right lifting condition against the Segal core inclusions
...
\begin{proof}
	...
	any map $Sc[T] \to \mathop{\mathrm{ho}}(Z)$ admits a factorization 
	$Sc[T] \to Z \xrightarrow{q} \mathop{\mathrm{ho}}(Z)$.
