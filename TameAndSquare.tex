...
Recall that the set of families $\F$ of a subgroup $G$ are in bijective correspondence with \textit{sieves} $O_\F \subseteq O_G$ of the orbit category of $G$;
...
\begin{definition}
      ...
      for all arrows $A \to B$ in $\mathcal C$, $B \in \mathcal S$ implies $A$ and $A \to B$ are also in $\mathcal S$.
\end{definition}
