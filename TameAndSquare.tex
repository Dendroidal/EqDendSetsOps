...
We begin by introducing weak indexing systems as ``Segal sieves'' in $\Omega_G$.
\begin{definition}
      ...
      A \textit{weak indexing system} is a full subcategory $\Omega_\F \subseteq \Omega_G$ such that
      \begin{enumerate}
      \item $\Omega_\F$ is a sieve, and
      \item any $T \in \Omega_\F$ satisfies the following Segal condition:
            \todo[inline]{come back}
      \end{enumerate}
\end{definition}


We unpack this and give an equivalent description.
Let $\Sigma_\F$ denote the full subcategory of $\Sigma_G$ spanned by the image of $\Omega_\F$ under the functor $\mathsf{lr}$;
by (i), this is equal to the subcategory of $\Omega_\F$ spanned by $G$-trees with a single $G$-vertex and quotient maps.
...
- still get Cor 2.22 since SIEVE
