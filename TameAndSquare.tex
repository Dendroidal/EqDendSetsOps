...
concluding a project to establish a homotopy theoretical equivalence
...
Our project can be regarded as the equivariant generalization
of the Cisinski-Moerdijk project 
\cite{CM13a,CM13b,CM11}
establishing the equivalence between
colored simplicial operads
and dendroidal sets.
The key novelty in the equivariant setting
is that the homotopy theory of operads
needs to account for a new piece of structure: norm maps.
