...
\begin{convention}
      ...
      a total order on $\boldsymbol{E}(T)$ which extends $\leq_d$.
\end{convention}
...
\begin{definition}
      ...
      by the functor which sends a $G$-tree $T$ to its root $G$-set.
\end{definition}
...
\begin{example}
      ...
      \[
            \begin{tikzcd}
                  X(H/K) \times \times X(K/L \amalg K/K) \arrow[r, dashed, bend left, shift left, "s"]
                  &
