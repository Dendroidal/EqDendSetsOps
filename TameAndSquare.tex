...
\begin{remark}
	The primary example of Notation \eqref{XUDECALT NOT}
	occurs when $A=\Omega[T]$ for $T \in \Omega_G$,
	in which case 
...
There is a characterization of joint weak equivalences between Segal operads
...
\begin{theorem}
      ...
      \item a map between Reedy fibrant Segal operads is a joint equivalence iff it is a Dwyer-Kan equivalence.
      \end{enumerate}
\end{theorem}
\begin{proof}
