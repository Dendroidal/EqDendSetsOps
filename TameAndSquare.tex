...
This last step requires some care \todo{and whose proof requires the main technical results of this paper}. 
...
(see \cite[\S 3]{MW07}, \cite[Rem. 4.4, Ex. 4.6]{Per18}, or \eqref{OMEGADEF_EQ}).
...
\begin{proposition}[{\cite[Prop. 2.2]{BP_edss}}]
	...
	A map of trees $\varphi \colon U \to V$ has a factorization, unique up to unique isomorphisms,
        \begin{equation}\label{NP_TREEFACT_EQ}
              ...
              V
        \end{equation}
        with the indicated properties: as a degeneracy followed by an inner face map followed by an outer face map.
\end{proposition}
...
\begin{proposition}[{cf. \cite[Prop. 2.2]{BP_edss}}]
      ...
      \begin{equation}
            \label{TREEFACT_EQ}
            U \xrightarrow{\simeq} U_p \xrightarrow{d,p} \phi U \xrightarrow{i,p} \bar{\phi U} \xrightarrow{o,p} V
      \end{equation}
      as indicated:
      an isomorphism, a planar degeneracy, a planar inner face, and a planar outer face.
\end{proposition}
