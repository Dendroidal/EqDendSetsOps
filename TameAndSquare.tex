...
\begin{remark}
      ...
      By Proposition \ref{NWCANX_PROP},
      $W(T) = \coprod W(T_i)$,
      and in fact it is clear that \eqref{WU_EQ} remains correct, replacing $U$ with $T$.
...
by applying Example \ref{WPARTIALT_EX}.
\begin{proposition}
