...
\begin{definition}
      ...
      The sets $\boldsymbol{E}(F)$, $\boldsymbol{E}^i(F)$, $\boldsymbol{V}(F)$ generalize immediately.
...
\begin{lemma}
      ...
      \item \( 
            ...
            \).
      \item \label{OPTENS_SQ_LBL} The square on the left below commutes (additionally, has a lift) iff the square on the right below commutes (has a lift),
            ...
            \begin{equation}
                  \begin{tikzcd}
                        ...
                        K \arrow[r] \arrow[d, "u"']
                        &
                        \O(\vect C)^{\Aut_{G \ltimes \Sigma_{\mathfrak C_\O}}(\vect C)} \arrow[d, "{F(\vect C)}"]
                        \\
                        ...
                        L \arrow[r]
                        &
                        \P(F(\vect C))^{\Aut_{G \ltimes \Sigma_{\mathfrak C_\O}}(\vect C)}
                  \end{tikzcd}
            \end{equation}
      \end{enumerate}
\end{lemma}
...
\begin{definition}
      Given $H \leq G$ and a $G$-set $\mathfrak C$, we have the following commuting square of left adjoints.
      \[
            \begin{tikzcd}
            ...
            \end{tikzcd}
      \]
      Explicitly, $G \cdot_H^{\mathfrak C} (-)$ on symmetric sequences is given by the left Kan extension over the inclusion
...
Standard adjunction and 3-variable-adjunction arguments yield the following.
\begin{lemma}
...
\begin{proof}
      ...
      this follows from Lemma \ref{OPTENS_LEM}\ref{OPTENS_SQ_LBL} and \eqref{GHTENS_EQ}.
\end{proof}
...
%       and the top horizontal map is adjoint to the identity map via \eqref{OPTENS_EQ}.
%       \todo[inline]{come back}
% \end{proof}
% \begin{remark}
...
%       the adjoint squares to \eqref{WLEFTQPUSH_EQ} as on the right in \eqref{OPTENS_EQ}(iv) are pushouts onto the terminal signatures
