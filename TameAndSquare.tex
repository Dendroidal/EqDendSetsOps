...
\begin{definition}
      For $T \in \Omega_G \subseteq \Phi_\bullet^{0,G}$, we define
      $\Omega(T) = \mathbb F \Sigma_\tau[T]$.
\end{definition}
Explicitly, $\Omega(T) \in \Op^G$ has $G$-set of colors $\mathfrak C = \boldsymbol{E}(T)$,
...
\todo[inline]{come back - this is unsatisfying and unilluminating}
{\color{OliveGreen} % ----------
