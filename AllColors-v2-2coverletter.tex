...
Since the last submission, we have made a couple minor changes for continuity between the three articles
[BPc], this paper, and [BPa], as all three have been edited/refereed almost simultaneously:
\begin{itemize}
\item We have added the adjective ``cofibrantly generated'' to the statement of Theorem A.
        This is well-established in the proof, but not stated in the result itself.
\item We have replaced all instances of ``$\mathfrak C$-signatures'' to $\mathfrak C$-profiles'' for uniformity across the three papers (both terms are used in the literature, but the latter more often).
\item The numerical references in this article to items in [BPc] and [BPa] have been updated to their newest versions.
\item The bibliography references to these three papers now refer to their updated arXiv listings (which in particular have the most up-to-date internal numbering of results and definitions).
\end{itemize}
