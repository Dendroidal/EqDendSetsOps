...
\item $(\mathsf{Set},\times)$ the category of sets with its canonical model structure,
      ...
      \todo[inline]{the model structure then on $\Op_\bullet^G$ is in fact the one induced by Stephan (unless $\F$ is empty),
        since an equivariant bijection induces a bijection on all fixed point sets.}
