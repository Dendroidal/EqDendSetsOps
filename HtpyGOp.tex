...
\begin{remark}
	...
	More precisely, \cite[Remark 6.45]{BP_geo} implies that
        a weak indexing system is precisely a pseudo indexing system consisting of $G$-graph subgroups (e.g. \cite[Def. 6.34]{BP_geo}).
...
%
	...
	\textit{family of $G$-corollas} in the sense of \cite[Def. 4.44]{BP_geo})
