...
\begin{remark}
      ...
      \begin{equation}
            ...
            \qquad
            \F_{\vect T} = \pi_{\vect T}^{\**}(\F_T)
      \end{equation}
      for $\pi_{\vect T} \colon \Aut_{G \ltimes \Omega_{\mathfrak C}^{op}}(\vect T) \to \Aut_{G \times \Omega_{\set{\**}}^{op}}(T)$.
\end{remark}
...
\begin{remark}
      When $\mathfrak C = \**$ and $\F$ is a {\color{blue} $(G,\Sigma)$-graph family (Definition \ref{GRAPHSUB_DEF})},
...
This description is suitable for detecting cofibrancy.
%
...
\]
Denote the category of $\underline{m}$-labeled $\mathfrak C$-trees and label-preserving isomorphisms maps by $\Omega^{\underline{m}}_{\mathfrak C}$.
...
\begin{remark}
      ...
      Defining $\nabla_m$, $\boldsymbol{V}_{\mathfrak C}^{\underline{m}}$ to be the natural functors below,
      \[
            G \ltimes \Omega_{\mathfrak C}^{\underline{m},op} \xrightarrow{\ \boldsymbol{V}_{\mathfrak C}^{\underline{m}} \ }
            \Sigma \wr \left( \coprod_m G \ltimes \Sigma_{\mathfrak C}^{op} \right) \xrightarrow{\ \nabla_m \ }
      ...
      we define
            ...
            \qquad
            \hat \F_{\mathfrak C}^{\underline{m}} = \left(\boldsymbol{V}_{\mathfrak C}^{\underline{m}}\right)^{\**} \F_{\mathfrak C}^{\underline{m}},
      \]
      % \begin{equation}
      %       \label{FCM_EQ}
      %       \begin{tikzcd}
      ...
      % \]
      % (using \eqref{PHIFLTIMES_EQ} for the last equality),
      so that
      \begin{equation}
            \label{VCM_LQ_EQ}
...
\begin{proof}
      ...
      \[
            ...
            \pi_{\mathfrak C}^{\**} \pi_{\mathsf{lr}}^{\**} \F =
            \pi_{\mathsf{lr}, \mathfrak C}^{\**} \pi_{\mathfrak C}^{\**} \F
      \]
...
\begin{proof}
      ...
      $n_k^{\O,X,Y}(\vect U)$ is a cofibration in $\V^{\Aut_{G \ltimes \Omega_{\mathfrak C}^{\underline{2},op}}(\vect U)}_{\F_{\vect U}}$
      by Proposition \ref{BOXVT_PROP}.
      However, the vertex labelings of alternating trees are equivariant in the sense that
      $\Aut_{G \ltimes \Omega_{\mathfrak C}^{\underline{2},op}}(\vect U) = \Aut_{G \ltimes \Omega_{\mathfrak C}^{op}}(\vect U)$.
