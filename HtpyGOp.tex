...
\begin{theorem}
      \label{THMIII}
      Suppose $\V$ satisfies the hypotheses in Theorem \ref{THMII},
...
\end{theorem}
This will be a special case of Corollary \ref{SIGMAG_COF_COR} from \S \ref{SGCOF_SEC}.
...
After defining the necessary conditions below, this result will follow as a special case of Corollary \ref{SIGMAG_COF_COR}.
