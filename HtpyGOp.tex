...
\begin{terminology}
	Maps $\O \to \mathcal{P}$
	satisfying the weak equivalence condition in 
	\eqref{THMIII1ST EQ} are called
	\emph{local equivalences}
	while maps satisfying both weak equivalence conditions in 
	\eqref{THMIII1ST EQ},\eqref{THMIII2ND EQ}
