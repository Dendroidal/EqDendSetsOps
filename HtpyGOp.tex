...
\begin{abstract}
	...
	both in the context of operads with fixed set of colors and in the context of all colored operads.
...
discusses how the usual notions from category theory
...
\begin{example}
	...
	$W_! \colon \sSet \to \Cat_{\bullet}(\sSet)$ is the left adjoint to the homotopy coherent nerve {\color{red} reference}.
\end{example}
