...
in the statement of Theorem \ref{THMIII},
...
of \eqref{FREEOP_EQ},
and to use this to prove necessary results used in the rest of the paper, 
...
$\mathsf{WSpan}^l(\Sigma_{\bullet}^{op},\mathcal{V})$
of spans (Definition \ref{SPANCAT DEF}),
...
\begin{definition}\label{SPANCAT DEF}
