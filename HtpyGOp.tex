...
are build by identifying these as algebras over a monad
...
%
Lastly, in \S \ref{EQCOSYMSOP SEC}, 
...
=
\{j \otimes X | j \in \mathcal{J},X \in \V^G\}.
\]
...
\eqref{GENGENSETEQ}.
All conditions therein are immediate except for
...
The following is immediate from Proposition \ref{EQQUILADJ PROP}.
...
\begin{remark}\label{COMBADJ REM}
	...
	Given a homomorphism $\phi \colon G \to \bar{G}$ and a $G$-set $\mathfrak{C}$,
