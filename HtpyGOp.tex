...
\cite[Not. 5.56]{Per_eds}, \cite[\S 2.3]{BP_edss}
...
\begin{equation}\label{FCA_SQ_EQ}
\begin{tikzcd}[column sep = small]
G^{o} \ltimes \Omega_{\mathfrak C}^{0,a}
\arrow[r] \arrow[d, "\pi_{\mathfrak C}^a"']
&
G^{o} \ltimes \Omega^{0,a} \arrow[r, "\boldsymbol{V}^a"]
\arrow[d, "\pi^a"]
&
\Sigma \wr (G^{o} \ltimes \Sigma)^{\amalg 2}
\arrow[d, "\Sigma \wr \nabla"]
& % ----------
G^{o} \ltimes \Omega_{\mathfrak C}^{0,a} \arrow[r, "\boldsymbol{V}_{\mathfrak C}^{a}"]
\arrow[d, "\pi_{\mathfrak C}^a"']
&
...
In order to build these structures,
we will need to strengthen our hypotheses on $\V$ (discussed throughout \S \ref{MS_SEC}).
