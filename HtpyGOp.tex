...
This finishes the proof that \eqref{FUNBLTICV EQ} has the right objects. The claim that it also has the right arrows is similar.
\end{proof}
...
by functors
$G \ltimes \Sigma_{\mathfrak{C}}^{op} \to \mathcal{V}$ for some $\mathfrak{C} \in \mathsf{Set}^G$.
