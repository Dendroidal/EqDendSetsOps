...
\begin{remark}\label{SPNONEX REM}
	...
	for equivariant colored spectal operads.

	More generally, if $\V$ is an arbitrary model category 
	the choice of the $(G,\Sigma)$-family in 
	Definition \ref{FAM1ST DEF}
	should then be replaced with a choice of model structures on
	$\V^{G \times \Sigma_n^{op}}$
	for each $n \geq 0$.	 
\end{remark}
