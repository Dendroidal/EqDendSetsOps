...
\begin{remark}\label{SEMI_REM}
	When working with operads, some authors {\color{red} cite examples}
	...
	has cofibrant source {\color{red} cite definition}.
(in particular, cofibrant replacements in a semi-model structure work as usual).
...
\begin{remark}\label{THMISM REM}
	...
	Hence, by {\color{red} cite something},
	the semi-model structure analogue of Theorem \ref{THMI}
	does not require the global axiom.
\end{remark}
