...
Our main goal in this paper is to extend
the graph equivalence model structures of
...
Alternatively, 
we will extend well known model structures of  
on all colored operads in
...
{\color{red} HERE}
 ...
 produces a model structure whose weak equivalences


{\color{red} HERE}

For example, is an identification
