...
indexed by tuples, called \emph{$\mathfrak{C}$-signatures},
...
beginning with \cite{SS00} and \cite{BM03} and including e.g. \cite{BM07,Mur11,Whi14,Whi,BB17,PS18,WY18},
...
We briefly recall the definition of a semi-model category, following \cite{Spi,Whi}.
...
\begin{remark}
      This definition is actually a special case of the definitions from \cite{Spi,Whi},
...
% 	In \cite{Spi,Whi}, these semi-model structures come equipped with an adjunction $\mathcal M \rightleftarrows \mathcal D$ with $\mathcal M$ a model category,
