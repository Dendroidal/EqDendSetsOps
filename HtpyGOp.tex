...
{\color{blue} note that this is not assuming $\F$ is a graph family}
...
\[
      ...
      \Sigma \wr  (G^{op}  \ltimes \Sigma_{\mathfrak{C}})
\]
for the natural extensions of the leaf-roof and vertex map {\color{red} from *earlier reference*}.
...
There is another natural notion of fibration, parallel to Dwyer-Kan equivalences and $\F$-$\pi_0$-essential surjectivity,
...
where
where $\mathbb{C}_{\partial \Delta[2]}$ denotes the colimit % informal ``union''
...
\begin{example}
      ...
      \item For higher arity operations,
            ...
            \]
            \todo[inline]{connect to \cite[Definition \ref{TAS-OT_DEF}]{BP_TAS}}
