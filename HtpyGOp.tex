...
(i.e. not present in the non-equivariant context)which must be considered
...
Notably, graph equivalences are not quite formal. For example, they can not be obtained by simply regarding
$\Op_{\**}(\mathsf{sSet}^G)$
as enriched operads.
