...
\hypersetup{
  % colorlinks,
  final,
  pdftitle={Equivariant simplicial operads},
  pdfauthor={Bonventre, P. and Pereira, L. A.},
  linktoc=page
}

% \usepackage{xr}
\externaldocument[TS-]{TameAndSquare} % cite using names from other half
...
\title{Equivariant simplicial operads}
...
\todo[inline]{do we need Lemmas \ref{TS-INTER_LEM} and \ref{TS-WJ EX} from TameAndSquare? Or, for that matter, \ref{SSET_COH_PROP}? This is basically a recreation of the cited results using minimal new terminology.}
