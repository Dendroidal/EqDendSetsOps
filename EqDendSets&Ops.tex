...
The above gives \cite[Lem 5.57]{PB17}.

\begin{proposition}
      [{cf. \cite[Prop 5.66]{BP17}}]
      For each $\UC$-profile $(C,\mathfrak c) \in \UC\Sigma_G$, we have a filtration of $\mathcal P[u]$ given by the following pushout in $\V^{\mathrm{Aut}(C)}$. 
\end{proposition}
