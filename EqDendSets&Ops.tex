...
\begin{remark}
      ...
      (in which case the two definitions of virtually equivalent coincide)
...
\begin{proof}
      ...
      Each $j^{\**}: \Op^{G, \mathfrak C}(\V) \to \Cat^{G, \mathfrak C}(\V)$ commutes with taking fixed points;
      moreover, each is right Quillen, and hence commutes with fibrant replacement.
      ...
      \begin{equation}
            \begin{tikzcd}
                 j^{\**} \O^H \arrow[r, "\simeq_l"] \arrow[d, dashed, "\simeq"']
                  &
                  F^{\**} (j^{\**}\P^H) \arrow[r, "\cong_l", two heads] \arrow[d, "\simeq"']
                  &
                  j^{\**} \P^H \arrow[d, "\simeq"]
                  \\
                  j^{\**} (\O^H)_f \arrow[r, dashed, two heads]
                  &
                  F^{\**} (j^{\**}(\P^H)_f) \arrow[r, "\cong_l", two heads]
                  &
                  j^{\**}(\P^H)_f
            \end{tikzcd}
      \end{equation}
      ...
      \begin{equation}
            \begin{tikzcd}
                  ...
                  &
                  j^{\**}(\O^H)_f \arrow[d, two heads, "\simeq_l"]
                  &&
                  \1 \amalg \1 \arrow[r, "{(a_0,a_1)}"] \arrow[d, tail, "{(i_0, i_1)}"']
                  &
                  a^{\**}j^{\**}(\O^H)_f \arrow[d, two heads, "\simeq"]
                  \\
...
\textit{characteristic edge lemma} \cite[Lemma 3.4]{BP17},
...
We can now finally discuss how to apply \cite[Lemma 3.4]{BP17}.
...
{\color{blue} Bla poset not finite but not important}
