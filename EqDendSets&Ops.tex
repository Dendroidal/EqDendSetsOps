...
\end{proposition}
\begin{proof}
      \todo[inline]{come back: can we remove the assumption that weak equivalences are closed?
        In particular, can we make this about composing trivial cofibrations?}
...
\begin{example}
      ...
      \todo[inline]{come back: can we remove the last constraint \ref{TCWE_LBL} in theorem.}
\end{example}
