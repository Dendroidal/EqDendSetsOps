...
Dwyer-Kan weak equiavlences were introduced in the context of simplicial categories by Dwyer-Kan and Bergner \cite{DK80, Ber07}.
...
We may now state and prove the main result of this section (cf. Theorem \ref{INTRO_MODEL_THM}).
...
\begin{example}
      ...
      \begin{itemize}
      \item $(\sSet, \times)$ and $(\sSet_{\**}, \wedge)$ both satisfy this by an argument of Joyal (see Proposition \ref{SSET_COH_PROP} below).
...
\begin{proof}
      ...
      This follows immediately from Theorem \ref{MODEL_THM} and Propositions \ref{WE_ARE_DK_PROP}, \ref{COH_DK_ARE_WE_PROP}, and \ref{SSET_COH_PROP}.
\end{proof}

\todo[inline]{come back: what about pointed simplicial sets? do they have an interval? are they coherent? etc etc.}
...
\begin{example}
      ...
      $\V$ the category of simplicial modules over a ring? (from \cite[Example 4.23]{Cav14}).
\end{example}
