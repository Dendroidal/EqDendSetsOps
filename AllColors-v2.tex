...
\begin{remark}
	...
	in \cite[Def. 1.2]{BM13}.
        ...
        However, they are generally uncomparable, as the end goals are distinct:
        our conditions serve to build fixed point model structures as in Theorem \ref{THMA},
