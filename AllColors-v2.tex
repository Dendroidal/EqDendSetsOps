...
\begin{remark}
	...
	in \cite[Def. 1.2]{BM13}.
        ...
        Moreover, the global monoid axiom, combined with the cofibrant symmetric pushout powers condition
        (i.e. the technical conditions (iv),(v) of Theorem \ref{THMA}),
        play a similar role to the hypotheses of ``adequacy'' in \cite[Prop. 1.4]{BM13},
        or, in another path,
        the $h$-monoidality condition of \cite{BB17}.
        However, while these choices of axioms play an analogous role internal to each theory, they are generally uncomparable, as the end goals are distinct:
