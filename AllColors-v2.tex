...
\begin{remark}
	...
	in \cite[Def. 1.2]{BM13}.
        ...
        play an analoguos role to the hypotheses of ``adequacy'' in \cite[Prop. 1.4]{BM13},
        or, for example,
        the $h$-monoidality condition of \cite{BB17}.
...
such that the induced map $\mathfrak C_\O^H \to \mathfrak C_\P^H$ on $H$-fixed colors is surjective
for all $H \in \F_1$.
\end{proposition}
