...
\item[(10)] Defining the homotopy colimit of a diagram to be the colimit of the cofibrant replacement of the diagram
        ...
        % If $\mathcal D$-shaped colimits are homotopy colimits, then $F \simeq F'$ implies $QF \simeq QF'$,so
        % the latter of which are levelwise cofibrant, so
        % $\colim F \colim QF \simeq \colim QF' \simeq \colim F'$.
...
\item[(35)] No change requested.
        % As a counter-exmaple to the use of [CM13b, Lemma 3.4] in [CM13b, Lemma 3.5], in their language,
        ...
        % also does not factor through $A_n$, but $s$ does not satisfy the hypotheses of [CM13b, Lemma 3.4].
        % ---------- Don't know if this is accurate. You (Luis) could probably say something more closely relating to (Ch0.1), though I cannot formulate it at this time.
\end{enumerate}
