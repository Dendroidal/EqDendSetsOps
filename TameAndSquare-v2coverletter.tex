...
\item[(7)] Clarified in Notation 3.1 that presheaves under $c_!$ are constant along the simplicial direction.
...
\item[(9)] Added definition of the pushout-product $\square$ to the end of Notation 3.1.
\end{enumerate}
