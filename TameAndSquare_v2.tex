...
\begin{proposition}[\cite{BP20}*{Prop. 2.2}]
...
\begin{notation}
      ...
      we write $(A \to B) \square (K \to L)$ for the pushout product map, with target $B \times L$ (see e.g. \cite{Ri14}*{11.1.7}).
\end{notation}
...
\end{equation}
	...
	Equivalently \cite[Rem. 4.41]{BP20},
