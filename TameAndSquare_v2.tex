...
\begin{remark}\label{DCC REM}
	...
	if it has no infinite descending chains or, equivalently, if any non-empty subset has a minimal element. As such, while  \cite[Lemma 3.4]{BP20}
...
%
%      More details and alternative definitions can be found in \cite[\S 9]{Per18},\cite[\S 4.4]{BP_geo},\cite[\S 3.4]{BP_ACOP}.
\end{remark}
