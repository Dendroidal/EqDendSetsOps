...
despite the broad parallels.
We believe this more formal approach is of intrinsic value,
...
that is, the only planar isomorphisms are the identities.
...
\begin{remark}
	...
	we write $NW(\mathfrak{n})_{\phi}(S) \subseteq NW(\mathfrak{n})(S) \in \sSet$
        for the subsimplicial set with simplicies
        those maps over a coloring $\phi \colon \boldsymbol{E}(S) \to \boldsymbol{E}(T)$;
