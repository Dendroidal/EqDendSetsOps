...
\begin{remark}
        ...
        where we note that condition (i) is the description given in \S \ref{MAINRESULT_SEC}.        
        \begin{enumerate}
...
{Because at no point in TAS do we actually say what we mean by the strict Segal condition in $\PreOp$,
  ...
  nor do we observe that the notation behaves as in Remark \ref{NERVEEVAL_REM}.

  Much of this can be shorted due to the longer introduction.}
...
% with $\Omega(T)$ as in \eqref{OMEGADEF_EQ}.
  ...
  The dendroidal nerve $N$ from \eqref{SOPDSET_EQ} COME BACK
