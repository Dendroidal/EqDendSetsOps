...
These operators satisfy a number of compatibilities (cf. \cite[Prop. 3.102]{BP_geo}). Firstly, the $d^i$, $s^j$ operators satisfy the  simplicial identities, 
...
\ar[bend right=35]{rd}[name=FFE]{} \ar{dd}
&&&
&&
\mathcal{E}  \ar{dd}
&&
