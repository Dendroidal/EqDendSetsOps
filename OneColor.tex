...
\S \ref{EHT_SEC} introduces and expands two concepts in equivariant homotopy theory.
First, in \S \ref{GMA_SEC}, we discuss the global monoid axiom mentioned in Theorem \ref{THMI}.
Then, in \S \ref{FGPP}, 
...
and is one of the key technical results in the whole paper. % of \S \ref{FIXCOL SEC}.
...
\S \ref{INDSYS SEC} proves Theorem \ref{THMII}
...
COME BACK - change \ref{EHT_SEC}

Added: \ref{GMA_SEC}, \ref{FGPP_SEC}

\textcolor{red}{add actual introduction}
...
\subsection{Families, groupoids, and pushout powers}
\label{FGPP_SEC}
