...
\begin{remark}
        ...
        % This paper develops the fixed-color solutions, while the direct sequel \cite{BP_ACOP} contends with their synthesis.
...
\begin{remark}\label{SEMI_REM}
	When working with operads, many authors (e.g. \cite{Spi,Whi17,WY18})
