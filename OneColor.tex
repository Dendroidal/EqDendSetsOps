...
\begin{remark}
        ...
        in the construction of the model structures on $\Op_\bullet^G(\V)$ from \cite[Thm. \ref{AC-THMA}]{BP_AC}.
        % However, the equivariant settings presents some technical challenges in both steps,
        % that will require us to reckage the non-equivariant narrative.
        % This paper develops the fixed-color solutions, while the direct sequel \cite{BP_AC} contends with their synthesis.
        The axioms for \cite[Thm. \ref{AC-THMA}]{BP_AC} consist of conditions (i) through (v) from Theorem \ref{THMI} plus three additional minor ones.
\end{remark}
...
The main result of \S \ref{REPFUN_SEC} is
...
Following the non-equivariant cases,
