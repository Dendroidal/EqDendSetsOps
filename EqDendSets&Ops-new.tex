...
$y \colon \Omega[U^y] \to Y$, and a subface $V \hookrightarrow U^y$ denote
...
one has
$\langle \partial_{U^e-\Xi^e}e \rangle \in  A_{<\langle e\rangle}$
iff
$\langle e \rangle \in  A_{<\langle e\rangle}$
iff
$\langle \partial_{U^e-E}e \rangle \in  A_{<\langle e\rangle}$,
so (Ch2),(Ch3) follow.
