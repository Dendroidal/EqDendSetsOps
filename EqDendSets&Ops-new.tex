...
one has that $T \colon \mathcal{T} \to \mathsf{Alg}_F^p(\mathcal{C})$ preserves cocartesian arrows so that the canonical map
...
\begin{remark}
Let $\Sigma_{\mathfrak{C}}[\vect{C}]
= \Sigma_{\mathfrak{C}}(-,\vect{C})$
denote the representable presheaf associated to $\vect{C} \in \Sigma_{\mathfrak{C}}$.
Moreover, using the $G$-action on $\Sigma_{\mathfrak{C}}$
we further write
$g^{\**}\Sigma_{\mathfrak{C}}[\vect{C}]
= \Sigma_{\mathfrak{C}}(g-,\vect{C})$
for each $g \in G$.
Note that the action isomorphisms
$\Sigma_{\mathfrak{C}}(\vect{D},\vect{C})
\simeq 
\Sigma_{\mathfrak{C}}(g\vect{D},g\vect{C})$
translate into isomorphisms
$g^{\**}\Sigma_{\mathfrak{C}}[\vect{C}]
= \Sigma_{\mathfrak{C}}(g - ,\vect{C}) \simeq 
\Sigma_{\mathfrak{C}}(- ,g^{-1}\vect{C}) =
\Sigma_{\mathfrak{C}}[g^{-1}\vect{C}]$.
By definition of $G \ltimes (-)$ we thus have natural identifications 
\[
	\left(G \ltimes \Sigma^{op}_{\mathfrak{C}}\right)
\left(\vect{C},\vect{D}\right)
\simeq
	(
	\coprod_{g \in G} g^{\**} \Sigma_{\mathfrak{C}}[\vect{C}]
	)\left(\vect{D}\right)
\simeq
	\left(
	\coprod_{g \in G} \Sigma_{\mathfrak{C}}[g^{-1}\vect{C}]
	\right)\left(\vect{D}\right)
\]
where we note that the middle formula is preferable for describing the 
$G \ltimes \Sigma^{op}_{\mathfrak{C}}$-functoriality on $\vect{D}$
while the last formula is preferable for describing the 
$G^{op} \ltimes \Sigma_{\mathfrak{C}}$-functoriality on $\vect{C}$.
Translating \eqref{VGFGEN EQ}, one then has that the generating (trivial) cofibratons of
...
to the maps in \eqref{VGSIGF EQ}. 
\end{remark}
...
\begin{notation}
      ...
      \begin{equation}
            ...
            \qquad
            \Sigma_{\mathfrak C}[K, \vect D](-) = \Hom_{\Sigma_{\mathfrak C}}(-, \vect D) \cdot_{\Aut(\vect D)}K.
      \end{equation}
