...
\begin{proof}
	...
	We claim that the following is a zigzag of weak equivalences in $\mathsf{sdSet}^G$.
        ...
        is an equivalence of Reedy fibrant objects in
        $(\mathsf{PreOp}^G_{tame})^{\Delta^{op}}$ (as $\gamma^{\**}\gamma_{\**}\tilde Q \to \tilde Q$ is a joint equivalence)
        and that $\Omega(T)$ is tame cofibrant.
