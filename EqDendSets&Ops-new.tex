...
Moreover, if $\F = \F_{all}$ is the collection of all subgroups of $G$, we denote the model structure $\V^{G}_{\F_{all}}$ simply by $\V^G$,
...
Applying Theorem \ref{FMODEL THM} induces an $\F$-model structure on the category of $\mathfrak C$-symmetric sequences in $\V$.
