...
We consider an factorization of the free operad monad orthogonal to \eqref{FC_FAC_EQ}, namely
\[
...
\begin{definition}
      A \textit{non-unital operad} is a symmetric sequence equipped with an associative and $\Sigma_\bullet$-equivariant composition law, but no units.
