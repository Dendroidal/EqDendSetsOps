...
(this follows from \cite[Cor. 5.38]{Per_eds} since no edge of $U^c$ is both a root and a leaf).
...
% ---------------------------------------- OLIVE GREEN ----------------------------------------
{\color{OliveGreen} using concatenations of pushout squares of the form
  \[
        \begin{tikzcd}
              ...
              \mathbb F X \arrow[r]
              &
              \mathbb F( \mathbb F_\eta X) \arrow[r]
              &
              \mathbb F_\eta^2 X,
        \end{tikzcd}
  \]
