...
\begin{theorem}[{\cite[Thm. 2.10]{Ste16}}]
      Let $\V$ be a cofibrantly generated model category, and $\F$ any family of subgroups of $G$ containing the trivial subgroup.
      Then
      \begin{itemize}
      \item the projective model structure on $\V^{\mathsf O_G^{op}}$ exists;
