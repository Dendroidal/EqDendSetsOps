...
\begin{proof}[Proof of Theorem \ref{THM1_C}]
      Proposition \ref{FILTPUSH_PROP} shows that we have an appropriate filtration of free extensions of colored operads,
...
\begin{lemma}
      ...
      \item \label{RJOINTT_LBL} If $X \in (\mathsf{sdSet}^G)^{\Delta^{op}}$ is fibrant in the Reedy-over-joint model structure,
            then for all $U in \Omega$, $X(U)$ is fibrant in the Reedy model structure on $(\mathsf{sSet})^{\Delta^{op}}$.
            \begin{proof}
...
\begin{proof}
      ...
      i.e. that for each tree $U \in \Omega$ the evaluations
      $\widetilde{Q}(U)(m) \to \widetilde{Q}(U)(0)$
      are graph-Kan equivalences in $\mathsf{sSet}^{\Aut(U)}$.
      \todo[inline]{make sure we have established initially what the ``usual'' Reedy model structure on $\mathcal M^{\Omega^{op} \times G}$ is}
      % 
      But since $\widetilde{Q}(U) \in \mathsf{sSet}^{\Delta^{op}}$ is itself Reedy fibrant by
      Lemma \ref{COMUOTOHOM_FACTS} \ref{RJOINTT_LBL},
      \todo[inline]{where is this Reedy fibrant?}
      ...
      $\widetilde{Q}(U)(0) \xrightarrow{\sim}
      \delta^{\**} \widetilde{Q}(U) \xleftarrow{\sim}
      \widetilde{Q}_0(U)$,
      ...
      \[\widetilde{Q}_0(U) = 
            \mathsf{Hom}_{\mathsf{sdSet}}(c_!\Omega[U],\widetilde{Q})=
            \mathsf{Hom}_{\mathsf{PreOp}}(c_!\Omega[U],\gamma_{\**}\widetilde{Q})\]
      \[
            \left(\gamma^{\**} N \widetilde{\mathcal{O}}\right)_0(U) = 
            \mathsf{Hom}_{\mathsf{sdSet}}(c_!\Omega[U],\gamma^{\**} N \widetilde{\mathcal{O}})=
            \mathsf{Hom}_{\mathsf{PreOp}}(c_!\Omega[U], N \widetilde{\mathcal{O}})
      \]
      for each $U \in \Omega$.
      ...
      \[
            \left(\gamma^{\**} N \widetilde{\mathcal{O}}\right)_0(U) = 
            \mathsf{Hom}_{\mathsf{PreOp}}(\Omega[U], N \widetilde{\mathcal{O}}) =
            \mathsf{Hom}_{\mathsf{sOp}}(\Omega(U),  \widetilde{\mathcal{O}})
      \]
      \[
            \left(hcN \widetilde{\mathcal{O}} \right)(U) = 
            \mathsf{Hom}_{\mathsf{sOp}}(W_!(U),  \widetilde{\mathcal{O}})
      \]
      so that the required claim follows since 
      $\widetilde{\mathcal{O}}$ is Reedy fibrant and
      $W(U) \to \Omega(U)$ is a weak equivalence of cofibrant operads.
...
For COMUOTOHOM PROP:
\begin{itemize}
\item $\tilde Q(m) \to \tilde Q(0)$ becomes an $\mathcal F$-joint equivalence in $\mathsf{sdSet}^G_{\mathcal F}$, with each $\tilde Q(m')$ $\mathcal F$-joint fibrant, and hence simplicial Reedy fibrant.
\item \cite[Prop. 4.1(ii)]{BP_edss} implies that $\tilde Q(m) \to \tilde Q(0)$ is an $\mathcal F$-simplicial equivalence:
      for each $U \in \Omega$, $\tilde Q(U)(m) \to \tilde Q(U)(0)$ is an $\mathcal F_U$-Kan equivalence in $\sSet^{\mathsf{Aut}(U)}_{\mathcal F_U}$.
\item Lemma \ref{COMUOTOHOM_FACTS} \ref{RJOINTT_LBL} implies that $\tilde Q(U)$ is $\mathcal F_U$-horizontally Reedy fibrant, i.e. fibrant in the category $\left((\sSet)^{\Delta^{op}}\right)^{\Aut(U)}_{\mathcal F_U}$.
\item \cite[Prop. 4.24(ii)]{BP_edss} (the proof of, using the 2-variable adjunction and the fact that $X_{G/H \cdot L} = (X_L)^H$) implies that $\tilde Q(U)$ is joint fibrant in $(\sSet^{\Delta^{op}})^{\Aut(U)}_{\mathcal F_U}$.
\item \cite[Prop. 4.5(iv)]{BP_edss} then implies $\tilde Q(U)_0 \to \delta^{\**}\tilde Q(U) \leftarrow \tilde Q(U)(0)$ are $\mathcal F_U$-Kan equivalences in $\sSet^{\Aut(U)}_{\mathcal F_U}$,
      hence $\tilde Q_0 \to \delta^{\**} \tilde Q \leftarrow \tilde Q(0)$ are $\mathcal F$-simplicial equivalences, and hence $\mathcal F$-joint equivalences.
\end{itemize}
