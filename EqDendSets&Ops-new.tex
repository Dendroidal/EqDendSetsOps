...
\begin{definition}
      ...
      \[
            \mathcal \F \sqcap \bar{\mathcal F} = \pi^{\**}(\F) \cap \bar\pi^{\**}(\bar \F),
            \qquad
      ...
      \[
            \begin{tikzcd}
                  ...
                  \\
                  &
                  \Lambda \times_G \bar\Lambda \arrow[u, "\Delta"]
            \end{tikzcd}
      \]
      \[
            \F^{\ltimes n} = (i_e)_{\**}\big(\pi_{e,\Lambda}^{\**}(\F)\big),
            \qquad
            \F^{\ltimes_G n} = \Delta^{\**}(\F^{\ltimes n}).
      \]
      \[
            ...
            \Sigma_n \wr \Lambda \xleftarrow{\Delta}
            \Sigma_n \wr_G \Lambda = \Sigma_n \ltimes \Lambda^{\times_G n}
      \]
\end{definition}
...
\begin{proposition}[{cf. \cite[Prop. 6.40]{BP_geo}}]
      ...
      \[
            ...
            \V^{\Lambda \times_G \bar\Lambda}_{\F \sqcap_G \bar\F}.
      \]
\end{proposition}
...
\begin{remark}[{cf. \cite[Remark 6.48]{BP_geo}}]
      ...
      $\Aut(T) \simeq \prod_{j=1}^r \Sigma_{|\lambda_j|} \wr \Aut(T_{i_j})$.
      ...
      \[
            \Aut(\vect T) \simeq \prod_{j=1}^s{}_G \Sigma_{|lambda_j} \wr_G \Aut(\vect T_{i_j})
      \]
\end{remark}
...
\begin{remark}
      ...
      \begin{align*}
        \F_T &= \pi^{\**}(\F_C) \cap \left( \F_{T_{i_1}}^{\ltimes_G |\lambda_1|} \sqcap_G \dots \sqcap_G \F_{T_{i_r}}^{\ltimes_G |\lambda_r|} \right),
        \\
        \F_{\vect T} &= \pi^{\**}(\F_{\vect C}) \cap \left( \F_{\vect T_{i_1}}^{\ltimes_G |\lambda_1|} \sqcap_G \dots \sqcap_G \F_{\vect T_{i_s}}^{\ltimes_G |\lambda_s|} \right),
      \end{align*}
      where $\pi$ denotes either map $G \times \Aut(T) \to G \times \Aut(C)$ or $\Aut(\vect T) \to \Aut(\vect C)$.
\end{remark}
...
\end{lemma}
\begin{proof}
      First, $\Gamma \in \F_T \cap \Aut(\vect T)$ iff $\pi_C(\Gamma) \in \Aut(\vect C)$.
      \[
            \begin{tikzcd}
      ...
      \[
            ...
            \big(\Sigma_{{e} \subseteq \boldsymbol{L}(C)} \times (G \times \Aut(T_l)) \big) \times_G
            \big( \Sigma_{\lambda \setminus \set{l}} \wr_G \prod_{j \neq l}{}_G G \times \Aut(T_j)\big)
            \Big) \in \F_{T_l},
      \]
      ...
      \[
            \pi_{G \times \Aut(T_l)}\Big(
            \big(\Sigma_{{e} \subseteq \boldsymbol{L}(C)} \times \Aut(\vect T_l)) \big) \times_G
            \big( \Sigma_{\vect \lambda \setminus \set{l}} \wr_G \prod_{j \neq l}{}_G \Aut(\vect T_j)\big)
            \Big) \in \F_{\vect T_l}.
      \]
...
\item $\langle p \rangle = \langle \partial_{T^e-E} e_p \rangle$ for some unique $E \subseteq \Xi^{e_p}$,
