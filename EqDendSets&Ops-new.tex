...
we have $\langle \partial_{T'} p \rangle = \langle p \rangle$, 
so that it must be that $T^a \to T$ is a degeneracy map,
i.e. that $p^a$
is a degeneracy of $p$.


For the ``if'' direction,
note first that the assumption $\langle p \rangle = \langle p^a \rangle$ guarantees that $\langle p \rangle$ is elementary.
Now choose
elementary $\langle q \rangle \subseteq \langle p\rangle$
with $\langle \partial_r q \rangle = \langle \partial_r p \rangle$.
By definition of $p^a,q^a$ it is then
$\langle q^a \rangle = \langle p^a\rangle$, and since
$\langle q \rangle$ is elementary it is
$\langle q^a \rangle \subseteq \langle q \rangle$.
But we then have
$\langle p^a \rangle = \langle q^a \rangle \subseteq \langle q \rangle \subseteq \langle p \rangle$,
so that the assumption 
$\langle p \rangle = \langle p^a \rangle$
implies $\langle q \rangle = \langle p \rangle$, as desired.
\end{proof}


{\color{red} HERE!}

{\color{purple} redefine canonical subpresheaves 
in terms of alternating dendrices}
...
canonical principal subpresheaf 
$\langle p^c \rangle$
such that
