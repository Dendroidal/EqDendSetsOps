...
If $\F = \F_{all}$ is the collection of all subgroups of $G$, we denote the model structure $\V^{G}_{\F_{all}}$ simply by $\V^G$,
...
\begin{notation}
      ...
      \begin{equation}
            ...
            \qquad
            \Sigma_{\mathfrak C}[K, \vect D](-) = \Hom_{\Sigma_{\mathfrak C}}(-, \vect D) \cdot_\Gamma K.
      \end{equation}
