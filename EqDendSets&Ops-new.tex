...
\todo{level genuine trivial cofibrations are closed under transfinite composites and pushouts, as colimits are computed levelwise},
...
\begin{proof}
      ...
      \[
            ...
            =
            \mathbb F f_! \left( \Sigma_{\mathfrak D}[\vect C] \cdot K \right)
            =
            \check f_! \mathbb F \left( \Sigma_{\mathfrak D}[\vect C] \cdot K \right).
      \]
