...
\cite[Prop. 5.49]{BP_geo}, there is hence a unique alternating tree $T^a$ together with a tall planar label map $T^a \to T$.
{\color{green} need to define reduced to be non-degenerate?}
