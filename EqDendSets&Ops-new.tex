...
To that end, for any $(G, \Sigma)$-family $\F = \set{\F_n}$ and all $\mathfrak C$-signatures $C \in G \ltimes \SC^{op}$ of length $n+1$, we define
$\F_C$ to be
\[
      \F_C = \sets{\Gamma \in \F_n}{\Gamma \leq \Aut_{G \ltimes \Sigma_{\mathfrak C}}(C) \leq G \times \Sigma_n}
\]
