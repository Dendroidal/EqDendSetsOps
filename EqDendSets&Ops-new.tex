...
Suppose the category $\mathcal{C}$ has 
two monads $P$ and $\bar{F}$,
as well as a monad structure on the composite 
$F = P \bar{F}$ such that
\begin{enumerate}[label=(\roman*)]
\item  $\eta_P \bar{F} \colon \bar{F} \Rightarrow P \bar{F} = F$
is a monadic natural transformation
...
\begin{lemma}\label{MODSTRCOM LEM}
The following diagrams commute
\begin{equation}\label{MODSTRCOM EQ}
\begin{tikzcd}
	PP\bar{F} \ar[Rightarrow]{r}{P\eta_{\bar{F}}P \bar{F}} 
	\ar[Rightarrow]{d}[swap]{\mu_P \bar{F}}
&
	P \bar{F} P \bar{F} \ar[equal]{r}
&
	FF \ar[Rightarrow]{d}{\mu_F}
&%%
	P \bar{F} \bar{F} \ar[Rightarrow]{r}{P \bar{F} \eta_{P} \bar{F}} 
	\ar[Rightarrow]{d}[swap]{P \mu_{\bar{F}}}
&
	P \bar{F} P \bar{F} \ar[equal]{r}
&
	FF \ar[Rightarrow]{d}{\mu_F}
...
\begin{proof}
The two claims are analogous, so we address only the first one.
Now consider the following diagram,
where the right square commutes since $F$ is a monad
and the left square commutes since $P \Rightarrow F$ is monadic.
\[
\begin{tikzcd}
	P P \bar{F} \ar[Rightarrow]{d}[swap]{\mu_P \bar{F}}
	\ar[Rightarrow]{r}
&
	FFF \ar[Rightarrow]{d}[swap]{\mu_F F}
	\ar[Rightarrow]{r}{F \mu_F}
&
	FF \ar[Rightarrow]{d}{\mu_F}
\\
	P \bar{F} \ar[Rightarrow]{r}
&
	FF \ar[Rightarrow]{r}[swap]{\mu_F}
&
	F
\end{tikzcd}
\]
By condition (iii) in Definition \ref{AMALGMON DEF}
the bottom composite is the identity and, similarly, the top composite is the top composite in the left diagram in \eqref{MODSTRCOM EQ},
proving the result.
\end{proof}
...
\begin{remark}\label{TWISTMAP REM}
We define the twist map $\tau \colon \bar{F} P \Rightarrow P \bar{F}$ as the composite
\[
\begin{tikzcd}
	\bar{F} P \ar[Rightarrow]{r}{\eta_P \bar{F} P \eta_{\bar{F}}}
&
	P \bar{F} P \bar{F} \ar[equal]{r}
&
	FF  \ar[Rightarrow]{r}{\mu_F}
...
&
	P P \bar{F} \bar{F}   \ar[Rightarrow]{r}{\mu_P \mu_{\bar{F}}}
&
	P \bar{F} \ar[equal]{r}
&
	F
...
where the top left square commutes by definition of the twist $\tau$,
the remaining top squares commute by Lemma \ref{MODSTRCOM LEM},
...
&
	P P \bar{F} \bar{F}  \ar[Rightarrow]{r}{\mu_P \bar{F} \bar{F}} \ar[Rightarrow]{d}
&
	P \bar{F} \bar{F} \ar[Rightarrow]{r}{P \mu_{\bar{F}}}
	\ar[Rightarrow]{d}
&
	P \bar{F} \ar[equal]{d}
\\
	FFFF \ar[Rightarrow]{r}{F \mu_F F}
	\ar[Rightarrow]{d}[swap]{\mu_F \mu_F}
&
	FFF \ar[Rightarrow]{r}{\mu_F F}
&
	FF \ar[Rightarrow]{r}{\mu_F}
&
	F \ar[equal]{d}
\\
	FF \ar[Rightarrow]{rrr}{\mu_F}
&&&
	F
\end{tikzcd}
\]
Condition (iii) in Definition \ref{AMALGMON DEF}
now says that the left vertical composite is the identity,
so that the left bottom composite is $\mu_F$,
while the top composite is 
\eqref{ALTMULT EQ}, as intended.
\end{proof}
...
\begin{lemma}\label{MODSTRCOM2 LEM}
The following diagrams commute
\begin{equation}\label{MODSTRCOM2 EQ}
\begin{tikzcd}
	P\bar{F}P \ar[Rightarrow]{r}{P \bar{F} P\eta_{\bar{F}}} 
	\ar[Rightarrow]{d}[swap]{P \tau}
&
	P \bar{F} P \bar{F} \ar[equal]{r}
&
	FF \ar[Rightarrow]{d}{\mu_F}
&%%
	\bar{F} P \bar{F} \ar[Rightarrow]{r}{\eta_{P} \bar{F} P \bar{F}} 
	\ar[Rightarrow]{d}[swap]{\tau \bar{F}}
&
	P \bar{F} P \bar{F} \ar[equal]{r}
&
	FF \ar[Rightarrow]{d}{\mu_F}
\\
	P P \bar{F} \ar[Rightarrow]{r}{\mu_P \bar{F}} 
&
	P \bar{F} \ar[equal]{r} 
&
	F
&%%
	\bar{F} \bar{F} P \ar[Rightarrow]{r}{\mu_{\bar{F}}P} 
&
	\bar{F} P \ar[equal]{r}
&
	F
...
Now consider the following diagram,
where the right square commutes since $F$ is a monad
and the left square commutes by definition of $\tau$.
\[
\begin{tikzcd}
	P \bar{F} P  \ar[Rightarrow]{d}[swap]{P \tau}
	\ar[Rightarrow]{r}
&
	FFF \ar[Rightarrow]{d}[swap]{F \mu_F}
	\ar[Rightarrow]{r}{\mu_F F}
&
	FF \ar[Rightarrow]{d}{\mu_F}
\\
	P F \ar[Rightarrow]{r}
...
\]
By condition (iii) in Definition \ref{AMALGMON DEF}
the top composite matches the top composite of the
left diagram in \eqref{MODSTRCOM2 EQ}
while the bottom composite matches the bottom composite of the left diagram \eqref{MODSTRCOM2 EQ}
by the (first half) of Lemma \ref{MODSTRCOM LEM}. 
\end{proof}
...
\begin{tikzcd}
	...
	\ar[Rightarrow]{d}[swap]{\bar{F} \mu_P}
&
	P \bar{F} P \ar[Rightarrow]{r}{P\tau}
&
	P P \bar{F} \ar[Rightarrow]{d}{\mu_P \bar{F}}
&%%
	\bar{F} \bar{F} P  \ar[Rightarrow]{r}{\bar{F} \tau}
	\ar[Rightarrow]{d}[swap]{\mu_{\bar{F}} P}
&
	\bar{F} P \bar{F}  \ar[Rightarrow]{r}{\tau \bar{F}}
&
	P \bar{F} \bar{F} \ar[Rightarrow]{d}{P \mu_{\bar{F}}}
\\
...
\begin{proof}
The two claims are analogous, so we address only the first one.
Now consider the following diagram, where the top section commutes by definition of $\tau$, the bottom left square commutes since 
$P \Rightarrow F$ is monadic,
and the bottom right square commutes since $F$ is a monad.
\[
\begin{tikzcd}
	&
	P \bar{F} P \ar[equal]{r}
	&
	F P \ar[Rightarrow]{d}
\\
	\bar{F} P P  \ar[Rightarrow]{d}[swap]{\bar{F} \mu_P}
	\ar[Rightarrow]{r}
	\ar[Rightarrow]{ru}{\tau P}
&
	FFF \ar[Rightarrow]{d}[swap]{F \mu_F}
	\ar[Rightarrow]{r}{\mu_F F}
&
...
\end{tikzcd}
\]
The bottom composite matched the bottom composite of the left diagram in 
\eqref{DOUBLETWIST EQ} by definition of $\tau$,
while the top right (outer) composite matches the 
top right composite of the left diagram in 
\eqref{DOUBLETWIST EQ}
by the first half of Lemma \ref{MODSTRCOM2 LEM}.
\end{proof}


\begin{remark}
The right side of \eqref{DOUBLETWIST EQ}
implies that $P$ can also be regarded as an 
endofunctor of $\mathsf{Alg}_{\bar{F}}(\mathcal{C})$
({\color{blue} when is comes to compatibility with multiplication}).

Similarly, the left side of \eqref{DOUBLETWIST EQ}
implies that $PP \to P$ is still a map of endofunctors of  
