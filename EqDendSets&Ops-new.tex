...
there exists an alternating dendrex $a^r$, \emph{unique up to isomorphism}, 
such that
$\langle \partial_r a^r \rangle = \langle r \rangle$.
%
...
$\langle \partial_{T^a} e \rangle = \langle a^{\partial_r e} \rangle$.

Crucially, note that we have just shown that if 
$\langle e \rangle$ is elementary then
$\langle a^{\partial_r e} \rangle \subseteq \langle e \rangle$.
...
{\color{red} Add this...}
If
$p^c$ is the canonical representative of
$\langle q^a\rangle$
and $q$ a non-degenerate representative of
$\langle q\rangle$
then $p^c$ is an inner face of $q$.
\end{remark}
