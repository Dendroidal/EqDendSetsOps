...
\begin{remark}
      ...
      \item[$(\bigstar)$] $(J^G)^{\otimes} \subseteq W^G$.
            ...
            \]
            {\color{blue} AND that this class is preserved under induction of groups (a la the left Kan extension)}
      \end{enumerate}
...
\item fixed point of genuine trivial cofibrations are trivial cofibrations!
