...
$\mathsf{Alg}_{\bar{F}}(\bar{F}X,Y) \simeq \mathcal{C}(X,Y) \simeq \mathsf{Alg}_{F}(FX,Y)$


\[
coeq \left(
FFX 
\underset{dog}{\overset{cat}{\rightrightarrows}}
FX
 \right)
 \left(
 \begin{tikzcd}
 FFX \ar[shift right=.3em]{r} \ar[shift left=.3em]{r} & FX
 \end{tikzcd}
 \right)
\]
...
coeq 
 ...
 FFX \ar[shift right=.3em]{r}[swap]{cat} \ar[shift left=.3em]{r}{dog} & FX
 \end{tikzcd}
 \right)
\]
