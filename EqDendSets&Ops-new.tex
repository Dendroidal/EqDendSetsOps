...
We can now prove the results given in the introduction to this subsection. \todo{reword. everything his follows from the non-equivariant proof}
...
\begin{lemma}
      [{cf. \cite[4.13]{Cav}, \cite[2.10]{BM13}}]
      \label{VIR_HTPY_LEM}
...
\begin{proof}
      ...
      Now, the proof of Lemma \ref{REF_VIRT_LEM} actually shows that
      ...
      and thus the coherence axiom implies that all homotopy $H$-equivalences are virtual $H$-equivalences;
