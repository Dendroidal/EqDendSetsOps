...
For the top pushout, Theorem \ref{INTCOF THM} imples that $\eta \to \mathbb{G}$
...
{\color{red} HERE}
      ...
      We now consider the bottom pushout.
...
``nice'' pullbacks in $\Cat(\V)$ preserve local equivalences which are bijective on objects.
