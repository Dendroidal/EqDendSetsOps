...
$\vect{B},\vect{C}$ be $\mathfrak{C}$-signatures,
and suppose 
$\Lambda \leq G \times \Sigma_n^{op}$
acts on both $\vect{B},\vect{C}$, i.e. 
$\Lambda \leq \mathsf{Aut}_{G\ltimes \Sigma_{\mathfrak{C}}^{op}}(\vect{B})$, 
$\Lambda \leq \mathsf{Aut}_{G\ltimes \Sigma_{\mathfrak{C}}^{op}}(\vect{C})$. Then:
\begin{enumerate}[label=(\roman*)]
\item suppose further that 
$\vect{B}=(\mathfrak{b}_1,\cdots,\mathfrak{b}_n;\mathfrak{c}_0)$,
$\vect{C}=(\mathfrak{c}_1,\cdots,\mathfrak{c}_n;\mathfrak{c}_0)$
have a common target $\mathfrak{c}_0$ and
that for some $\mathbb{K} \in \V$
one has maps 
$\mathbb{K} \xrightarrow{\kappa_i} \P(\mathfrak{b}_i;\mathfrak{c}_i), 1\leq i \leq n$
such that $g\kappa_{\sigma(i)} = \kappa_i$ for all $g\sigma\in \Lambda,1\leq i \leq n$. Then one has $\Lambda$-equivariant maps as below, where the right map is the composition in $\P$
...
\begin{equation}\label{LAMBEQMAPS EQ}
	...
	\mathbb{K}^{\otimes n}
\xrightarrow{id \otimes \bigotimes \kappa_i}
...
$\vect{B}=(\mathfrak{c}_1,\cdots,\mathfrak{c}_n;\mathfrak{b}_0)$,
$\vect{C}=(\mathfrak{c}_1,\cdots,\mathfrak{c}_n;\mathfrak{c}_0)$
have common sources $\mathfrak{c}_1,\cdots,\mathfrak{c}_n$
and that for some $\mathbb{K} \in \mathcal{V}$
one has a map $\mathbb{K} \to \P(\mathfrak{b}_0;\mathfrak{c}_0)$
such that $g\kappa = \kappa$ for all $g\sigma \in \Lambda$.
Then one has $\Lambda$-equivariant maps as below, where the right map is the composition in $\P$.
\[
