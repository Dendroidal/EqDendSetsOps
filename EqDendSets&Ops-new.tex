...
The cost, as is often the case, is that we cannot find such a filtration of operads, and instead
only produce a filtration in $\Sym^{G, \mathfrak C}(\V)$,
...
\begin{remark}
      ...
      With these tools in hand, $\S 5.1 -- 5.3$ of \cite{BP_geo} can be directly adapted to build the filtration in question.
